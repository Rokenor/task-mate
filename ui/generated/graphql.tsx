...
export type UpateTaskMutationVariables = {
  input: UpdateTaskInput;
};


export type UpateTaskMutation = (
  { __typename?: 'Mutation' }
  & { updateTask?: Maybe<(
    { __typename?: 'Task' }
    & Pick<Task, 'id' | 'title' | 'status'>
...
export const UpateTaskDocument = gql`
    mutation UpateTask($input: UpdateTaskInput!) {
  updateTask(input: $input) {
    ...
    `;
export type UpateTaskMutationFn = ApolloReactCommon.MutationFunction<UpateTaskMutation, UpateTaskMutationVariables>;

/**
 * __useUpateTaskMutation__
 *
 * To run a mutation, you first call `useUpateTaskMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpateTaskMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [upateTaskMutation, { data, loading, error }] = useUpateTaskMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpateTaskMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpateTaskMutation, UpateTaskMutationVariables>) {
        return ApolloReactHooks.useMutation<UpateTaskMutation, UpateTaskMutationVariables>(UpateTaskDocument, baseOptions);
      }
export type UpateTaskMutationHookResult = ReturnType<typeof useUpateTaskMutation>;
export type UpateTaskMutationResult = ApolloReactCommon.MutationResult<UpateTaskMutation>;
export type UpateTaskMutationOptions = ApolloReactCommon.BaseMutationOptions<UpateTaskMutation, UpateTaskMutationVariables>;